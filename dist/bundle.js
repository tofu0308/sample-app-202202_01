...
define("state/project-state", ["require", "exports", "models/project"], function (require, exports, project_1) {
    ...
    class ProjectState extends State {
        ...
        addProject(title, description, manday) {
            const newProject = new project_1.Project(Math.random().toString(), title, description, manday, project_1.ProjectStatus.Active);
...
define("components/project-input", ["require", "exports", "components/base-component", "util/validation", "decorators/autobind", "state/project-state"], function (require, exports, base_component_1, validation_1, autobind_1, project_state_1) {
    ...
    class ProjectInput extends base_component_1.Component {
        ...
        gatherUserInput() {
            ...
            if (!(0, validation_1.validate)(titleValidatable) || !(0, validation_1.validate)(descriptionValidatable) || !(0, validation_1.validate)(mandayValidatable)) {
                alert('入力値が正しくない');
                return;
            }
            else {
...
define("components/project-item", ["require", "exports", "components/base-component", "decorators/autobind"], function (require, exports, base_component_2, autobind_2) {
    ...
    class ProjectItem extends base_component_2.Component {
        ...
        configure() {
            this.element.addEventListener('dragstart', this.dragStartHadler);
    ...
    __decorate([
        autobind_2.autobind
    ], ProjectItem.prototype, "dragStartHadler", null);
    exports.ProjectItem = ProjectItem;
});
define("components/project-list", ["require", "exports", "models/project", "components/base-component", "decorators/autobind", "state/project-state", "components/project-item"], function (require, exports, project_2, base_component_3, autobind_3, project_state_2, project_item_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
